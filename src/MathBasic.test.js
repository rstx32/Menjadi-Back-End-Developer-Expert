...
describe('A MathBasic', () => {
  ...
  describe('A subtract function', () => {
    ...
    it('should return a - b when fiven two number parameters', () => {
      expect(MathBasic.subtract(4, 2)).toEqual(2)
      expect(MathBasic.subtract(6, 1)).toEqual(5)
      expect(MathBasic.subtract(9, 3)).toEqual(6)
    })
  })
  ...
  describe('A multiply function', () => {
    ...
    it('should return a - b when fiven two number parameters', () => {
      ...
      expect(MathBasic.multiply(6, 1)).toEqual(6)
      expect(MathBasic.multiply(9, 3)).toEqual(27)
    })
  })
  ...
  describe('A divide function', () => {
    ...
    it('should return a - b when fiven two number parameters', () => {
      ...
      expect(MathBasic.divide(6, 1)).toEqual(6)
